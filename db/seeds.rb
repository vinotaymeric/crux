...
if Basecamp.count == 0
  Basecamp.create!(name: "Chamonix", activity_id: 1)
  Basecamp.create!(name: "Chamonix", activity_id: 2)
  Basecamp.create!(name: "Chamonix", activity_id: 3)
  Basecamp.create!(name: "Chamonix", activity_id: 4)
  Basecamp.create!(name: "Annecy", activity_id: 1)
  Basecamp.create!(name: "Annecy", activity_id: 3)
  Basecamp.create!(name: "Grenoble", activity_id: 1)
  Basecamp.create!(name: "Grenoble", activity_id: 4)
end

puts "Seeding itineraries..."
if Itinerary.count == 0
  Itinerary.create!(name: "Petite promenade", content: "Balblabal...", activity_id: 1)
  Itinerary.create!(name: "Petite promenade", content: "Balblabal...", activity_id: 2)
  Itinerary.create!(name: "Petite promenade", content: "Balblabal...", activity_id: 3)
  Itinerary.create!(name: "Petite promenade", content: "Balblabal...", activity_id: 3)
  Itinerary.create!(name: "Petite promenade", content: "Balblabal...", activity_id: 4)
end
...
puts "Seeding trips..."
if Trip.count == 0
  Trip.create!(title: "Mon weekend", user_id: 1)
end

puts "Seeding tripsbasecamps..."
if TripsBasecamp.count == 0
  TripsBasecamp.create!(trip_id: 1, basecamp_id: 1)
  TripsBasecamp.create!(trip_id: 1, basecamp_id: 2)
  TripsBasecamp.create!(trip_id: 1, basecamp_id: 3)
  TripsBasecamp.create!(trip_id: 1, basecamp_id: 4)
  TripsBasecamp.create!(trip_id: 1, basecamp_id: 5)
  TripsBasecamp.create!(trip_id: 1, basecamp_id: 6)
end

puts "Seeding basecampsitineraries..."
if BasecampsItinerary.count == 0
  BasecampsItinerary.create!(itinerary_id: 1, basecamp_id: 1)
  BasecampsItinerary.create!(itinerary_id: 1, basecamp_id: 2)
  BasecampsItinerary.create!(itinerary_id: 2, basecamp_id: 1)
  BasecampsItinerary.create!(itinerary_id: 2, basecamp_id: 3)
  BasecampsItinerary.create!(itinerary_id: 3, basecamp_id: 4)
  BasecampsItinerary.create!(itinerary_id: 2, basecamp_id: 2)
end
# puts "Seeding Itineraries..."
